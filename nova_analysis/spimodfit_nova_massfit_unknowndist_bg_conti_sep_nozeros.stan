data {
    ...
    //    real distance_alpha[Nsky];     // gamma distribution alpha parameter for distance
    //	  real distance_beta[Nsky;       // gamma distribution beta parameters (=1/theta) for distance
...
model {
    ...
    dist ~ gamma(4.25,0.408);		             // gamma prior(s) for the dist
